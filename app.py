...
from python_code.minimization.penalty_method import minimize_penalty_in_boundary
...
def experiment(df, model):
    ...
    for state in states:
        ...
        res1 = minimize_penalty_in_boundary(regressor, 0, 10 * 60 * 60, 12 * 60 * 60, 10, nelder_mead_minimize)
        res2 = minimize_penalty_in_boundary(regressor, 13 * 60 * 60, 10 * 60 * 60, 12 * 60 * 60, 10,
...
if __name__ == '__main__':
    ...
    res = minimize_penalty_in_boundary(regressor, 13 * 60 * 60, 10 * 60 * 60, 12 * 60 * 60, 10, nelder_mead_minimize)
